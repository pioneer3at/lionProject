...
class PiHQCamera():
    def __init__(self, resolution=(640, 480), framerate=5):
        ...
        self.video_capture.preview_configuration.main.size=(1280,720)
        self.video_capture.preview_configuration.main.format="XRGB8888"
        self.video_capture.preview_configuration.align()
    ...
    def show_camera(self):
        ...
        try:
            while True:
                cv2.imshow("Livefeed", self.video_capture.capture_array())
...
if __name__ == "__main__":
    cam = PiHQCamera(resolution=(1920, 1080),framerate=60)
    cam.start()
    cam.show_camera()
    # cam.record_video()
    # time.sleep(2)
